...
### This is a working progress for the remote sensing & gg paper
...
### This is a glimpse of the dataset and variables we have

```{r ggpaper2, echo=FALSE, message=FALSE, warning=FALSE}
glimpse(gg1)
```

### Visualize grass grub densities
...
### Visualize density distribution of all variables in the dataset per year

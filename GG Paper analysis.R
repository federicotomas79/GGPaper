...
draw_confusion_matrix <- function(cm) {
  ...
  # create the matrix 
  rect(150, 430, 240, 370, col='#28ACB4')
  text(195, 435, 'High Levels', cex=1.2)
  rect(250, 430, 340, 370, col='#4397D2')
  text(295, 435, 'Low Levels', cex=1.2)
  text(125, 370, 'Predicted', cex=1.3, srt=90, font=2)
  text(245, 450, 'Actual', cex=1.3, font=2)
  rect(150, 305, 240, 365, col='#4397D2')
  rect(250, 305, 340, 365, col='#28ACB4')
  text(140, 400, 'High Levels', cex=1.2, srt=90)
  text(140, 335, 'Low Levels', cex=1.2, srt=90)
  ...
  text(30, 35, names(cm$overall[1]), cex=1.3, font=2)
  text(30, 20, round(as.numeric(cm$overall[1]), 3), cex=1.3)
  text(70, 35, names(cm$overall[2]), cex=1.3, font=2)
  text(70, 20, round(as.numeric(cm$overall[2]), 3), cex=1.3)
}  
